...
namespace DeBroglie.Wfc
{
    ...
    /// </summary>
    internal class PriorityEntropyHeuristic : IPickHeuristic
    {
        private PriorityEntropyTracker entropyTracker;

        private Func<double> randomDouble;

        public PriorityEntropyHeuristic(PriorityEntropyTracker entropyTracker, Func<double> randomDouble)
        {
